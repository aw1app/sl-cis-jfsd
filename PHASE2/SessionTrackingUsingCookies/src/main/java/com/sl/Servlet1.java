	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Cookie cookie : cookies) {
			if (cookie.getName().equals("sessIdStr")) {
				...
				out.println("<p> SERVLET 1: Found the session id cookie in this request " + sessIdStr);
				break;
			}
		}
		}
		...
		if (sessionIdCookieFound == false) {
			out.println("<p> SERVLET 1:  No session id cookie was found in this request. So creating one to start tracking");
