...
export class ProductListComponent {
  ...
  constructor(){
    console.log("Hi");
    this.products= [];
    this.products.push(new Product(1, "HP Laptop",20000, "Gaming Laptop",true,"IMAGES\hp.jpg"));
    this.products.push(new Product(2, "Samsumg Laptop",40000, "Gaming Laptop",true,"IMAGES\hp.jpg"));
